...
@router.get("/employee/{employee_id}", summary="Get complete employee dashboard data")
async def get_employee_dashboard(employee_id: str):
    """
    Returns comprehensive employee data including leaves, onboarding, activity, and vibe scores.
